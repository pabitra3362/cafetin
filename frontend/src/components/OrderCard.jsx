      ...
      {!isDone && (
        <div className="w-full md:w-[80vw] lg:w-[80vw] px-3 mx-auto">
          <div className="flex justify-around lg:justify-around gap-1 items-center bg-white shadow-md shadow-black my-5 py-3 rounded-lg lg:px-3">
            {/* Image */}
            <div className="w-40 h-48 lg:w-20 lg:h-20 overflow-hidden flex justify-center items-center rounded-lg">
              <img className="w-40 lg:w-20" src={img} alt="Order Item" />
            </div>

            {/* Information */}
            <div className="information grid lg:flex justify-items-start lg:justify-around items-start lg:items-center w-36 lg:w-[800px] gap-2">
              <div className="title text-black font-bold text-2xl lg:w-80">
                {title}
              </div>
              <div className="price font-bold text-lg lg:w-16 flex items-center gap-2 text-black">
              ...
              {user && (
                <div className="user-info flex justify-between w-full lg:w-28 items-center rounded-lg text-black font-bold">
                  <p>User: {user}</p>
                </div>
              )}
              {admin && (
